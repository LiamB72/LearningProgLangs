...
char matiere[][nbNotes] = {"Ens. Sci.","Hist./Geo.","L.V. A     ","L.V. B     ","EPS        ","Ens-Spe 1e", "Bull. Scol.", "Francais", "Philosophie","Grand Oral","Ens. Spe. 1","Ens. Spe. 2"};
...
int main ()
{
  ...
  for (int i = 0; i <= nbNotes-1; i++)
  {
    printf("Enter your note for %s : ", matiere[i]);
    scanf("%f", &notes[i]);
  }
